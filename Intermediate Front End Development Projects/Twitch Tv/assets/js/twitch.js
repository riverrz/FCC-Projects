var data= [
  ...
  },
  {
    ...
    "default_pic":"https://static-cdn.jtvnw.net/user-default-pictures/cd618d3e-f14d-4960-b7cf-094231b04735-profile_image-70x70.jpg",
    "_links": {
...
function displayChannels(mode) {
	$(".channels").remove();
	if (mode!=="offline") {
		for (var i=0;i<online.length;i++) {
			render(online[i],"online");
		}	
	}
	if (mode==="online") {
		return;
